...
import { apiGetMyResumes, apiDeleteResume } from '../api.js';
                ...
                >
                  ...
                  {isAnalyzed && resume.analysis && (
                    <div className="mb-3 space-y-1">
                      ...
                      {resume.analysis.skillGap?.atsScore != null && (
                        <ScoreBar label="Skill Gap Score" value={resume.analysis.skillGap.atsScore} />
                      )}
                    </div>
                  )}
